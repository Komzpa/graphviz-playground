...
the size of any arrowhead drawn on the edge. The attributes
{\tt arrowheadsize} and {\tt arrowtailsize} specify the factor independently
for the head and tail ends; when unset, they default to {\tt arrowsize}.
