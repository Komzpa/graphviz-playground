...
For eligible incoming and outgoing edge fans, \dot\ may insert
point junction nodes before ranking so those edges share one trunk.
This can change ranks and drawings that already used
\verb"concentrate=true".
