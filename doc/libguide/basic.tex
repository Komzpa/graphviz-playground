...
{\tt arrowheadsize} & & scaling factor for arrowhead at head end \\
{\tt arrowsize} & {\tt 1.0} & scaling factor for arrowheads \\
{\tt arrowtailsize} & & scaling factor for arrowhead at tail end \\
...
the {\tt arrowhead}, {\tt arrowheadsize}, {\tt arrowsize},
{\tt arrowtailsize}, {\tt arrowtail} and {\tt dir}
...
The actual
shape and width of the arrowhead is determined by the {\tt arrowtail},
{\tt arrowtailsize} and {\tt arrowsize} attributes. Analogously, an arrowhead
at the head node is
