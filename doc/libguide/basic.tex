...
{\tt nslimitexact} & & bounds network simplex iterations by this exact value when setting x-coordinates \\
{\tt nslimit1} & & if set to {\it f}, bounds network simplex iterations by {\it (f)(number of nodes)} during rank assignment \\
{\tt nslimit1exact} & & bounds network simplex iterations by this exact value during rank assignment \\
