...
typedef LIST(Agnode_t *) node_queue_t;
    ...
    extern bool edge_attributes_are_equal(edge_t *, edge_t *);
    extern bool opposite_edge_attributes_are_equal(edge_t *, edge_t *);
    extern bool opposite_edge_ports_are_equal(edge_t *, edge_t *);
