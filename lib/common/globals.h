...
GLOBALS_API EXTERN char *Gvfilepath;  /* Per-process path of files allowed in
                                         image attributes (also ps libs) */
GLOBALS_API EXTERN char *Gvimagepath; /* Per-graph path of files allowed in
                                         image attributes  (also ps libs) */
...
GLOBALS_API extern show_boxes_t
    Show_boxes;                      // emit code for correct box coordinates
...
GLOBALS_API EXTERN int
    EdgeLabelsDone; /* true if edge labels have been positioned */
...
GLOBALS_API EXTERN int
    GvExitOnUsage; /* gvParseArgs() should exit on usage or error */
...
GLOBALS_API EXTERN Agsym_t *N_height, *N_width, *N_shape, *N_color,
    *N_fillcolor, *N_fontsize, *N_fontname, *N_fontcolor, *N_label,
    *N_labelwrapwidth, *N_xlabel, *N_nojustify, *N_style, *N_showboxes,
    *N_sides, *N_peripheries, *N_ordering, *N_orientation, *N_skew,
    *N_distortion, *N_fixed, *N_imagescale, *N_imagepos, *N_layer, *N_group,
    *N_comment, *N_vertices, *N_z, *N_penwidth, *N_gradientangle;
