...
static bool is_concentrate_endpoint_attr(const concentrate_compat_state_t *state,
                                         const Agsym_t *attr) {
...
static void normalize_edge(const concentrate_compat_state_t *state, edge_t *e,
    ...
    *normalized = (concentrate_normalized_edge_t){0};
    ...
    normalized->samehead = state->samehead == NULL ? ""
                                                   : agxget(normalized->edge,
                                                            state->samehead);
    normalized->sametail = state->sametail == NULL ? ""
                                                   : agxget(normalized->edge,
                                                            state->sametail);
...
void concentrate_edge_pair_compat_init(
